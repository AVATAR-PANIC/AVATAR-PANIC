...
public class GeoDataRepository
{
	...
	for (String string : parts)
	{
	    ...
	    addItem(getGeoPointFromURLString(string),
		    new DataObject());
	}
    }
    ...
    /*
     * this method takes the contents of the map and returns them as a collection of Entries
     */
		...
		.entrySet())
	{
	    ...
	    for (DataObject dataObject : entry.getValue())
	    {
		java.util.Map.Entry<GeoPoint, DataObject> newEntry = new SimpleEntry<GeoPoint, DataObject>(entry.getKey(),dataObject);
    ...
    public class SimpleEntry<K extends Object, V extends Object> implements java.util.Map.Entry<K, V>
    {
